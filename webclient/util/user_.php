...
<div id="pageMiddle">
    ...
    <div id="lab">
        ...
        <textarea id="code" name="code"  rows="14" >#define F_CPU 1000000L
#include <avr/io.h>
...
<textarea id="output" rows="10" cols="85" readonly></textarea>
        </div>
        
        <div id="live">
        	<iframe width="660" height="400" src="http://72.252.157.203:8081" scrolling="no" frameborder="0">
